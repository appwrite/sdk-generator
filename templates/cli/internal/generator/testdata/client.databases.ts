...
const createQueryBuilder = <T>(): QueryBuilder<T> => ({
  ...
  count: (attribute = '*', alias = '') => Query.count(attribute, alias),
  countDistinct: (attribute, alias = '') => Query.countDistinct(attribute, alias),
  sum: (attribute, alias = '') => Query.sum(attribute, alias),
  avg: (attribute, alias = '') => Query.avg(attribute, alias),
  min: (attribute, alias = '') => Query.min(attribute, alias),
  max: (attribute, alias = '') => Query.max(attribute, alias),
  stddev: (attribute, alias = '') => Query.stddev(attribute, alias),
  stddevPop: (attribute, alias = '') => Query.stddevPop(attribute, alias),
  stddevSamp: (attribute, alias = '') => Query.stddevSamp(attribute, alias),
  variance: (attribute, alias = '') => Query.variance(attribute, alias),
  varPop: (attribute, alias = '') => Query.varPop(attribute, alias),
  varSamp: (attribute, alias = '') => Query.varSamp(attribute, alias),
  bitAnd: (attribute, alias = '') => Query.bitAnd(attribute, alias),
  bitOr: (attribute, alias = '') => Query.bitOr(attribute, alias),
  bitXor: (attribute, alias = '') => Query.bitXor(attribute, alias),
  groupBy: (attributes) => Query.groupBy(attributes),
  having: (queries) => Query.having(queries),
  ...
  crossJoin: (table, alias = '') => Query.crossJoin(table, alias),
  vectorDot: (attribute, vector) => Query.vectorDot(attribute, vector),
  vectorCosine: (attribute, vector) => Query.vectorCosine(attribute, vector),
  vectorEuclidean: (attribute, vector) => Query.vectorEuclidean(attribute, vector),
  covers: (attribute, values) => Query.covers(attribute, values),
  notCovers: (attribute, values) => Query.notCovers(attribute, values),
  spatialEquals: (attribute, values) => Query.spatialEquals(attribute, values),
  notSpatialEquals: (attribute, values) => Query.notSpatialEquals(attribute, values),
});
