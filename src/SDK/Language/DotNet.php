...
class DotNet extends Language {
    ...
    public function getFiles()
    {
        return [
            ...
            [
                'scope'         => 'default',
                'destination'   => '/src/Appwrite/Client.cs',
                'template'      => 'dotnet/src/Appwrite/Client.cs.twig',
                'minify'        => false,
            ],
            [
                'scope'         => 'default',
                'destination'   => '/src/Appwrite/Helpers/ExtensionMethods.cs',
            ...
            [
                'scope'         => 'default',
                'destination'   => '/src/Appwrite/Services/Service.cs',
                'template'      => 'dotnet/src/Appwrite/Services/Service.cs.twig',
                'minify'        => false,
            ],
            [
                'scope'         => 'service',
                'destination'   => '/src/Appwrite/Services/{{service.name | caseUcfirst}}.cs',
