...
// captured output, not output anyone wrote by hand -- regenerate with
// docs/go-cli/capture-generate-baselines.ts rather than editing them.
//
...
func TestEndpointWithQueryStringSurvives(t *testing.T) {
	...
	// TypeScript CLI, reproduced here; see internal/typegen/handlebars.go.
