...
final class DartStableTest extends Base
{
    ...
    protected string $command =
        'docker run --network="mockapi" --rm -v $(pwd):/app -w /app/tests/e2e/sdks/dart dart:stable sh -c "dart pub get && dart pub run tests/tests.dart"';
    ...
    protected array $expectedOutput = [
        ...
        ...Base::EXECUTION_COMPAT_RESPONSES,
    ];
}
