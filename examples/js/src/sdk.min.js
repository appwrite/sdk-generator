...
let path='/auth/oauth/{provider}'.replace(new RegExp('{provider}','g'),provider);return window.location=config.endpoint+path+'?1=1'},recovery:function(email,reset){if(email===undefined){throw new Error('Missing required parameter: "email"')}
