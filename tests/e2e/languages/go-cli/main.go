// Conformance harness for the Go CLI.
//
...
//
// Deliberately standalone: no shared file with the TypeScript CLI's harness and
...
func main() {
	...
	home, err := os.MkdirTemp("", "appwrite-go-cli-conformance-")
	if err != nil {
		fail(err)
	}
