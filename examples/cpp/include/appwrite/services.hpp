...
This endpoint
     ...
     * @return appwrite::Result<appwrite::BinaryResponse>
     */
    [[nodiscard]] appwrite::Result<appwrite::BinaryResponse> getDeploymentDownload(        std::string_view functionId,         std::string_view deploymentId,         std::optional<appwrite::enums::DeploymentDownloadType> type = appwrite::enums::DeploymentDownloadType::SOURCE    ) {
     ...
     * @return appwrite::Result<appwrite::BinaryResponse>
     */
    [[nodiscard]] appwrite::Task<appwrite::Result<appwrite::BinaryResponse>> getDeploymentDownloadAsync(        std::string_view functionId,         std::string_view deploymentId,         std::optional<appwrite::enums::DeploymentDownloadType> type = appwrite::enums::DeploymentDownloadType::SOURCE    ) {
                std::string path_ = std::format("/functions/{}/deployments/{}/download", functionId, deploymentId);
...
If you're creating a new file using
     ...
     * @return appwrite::Result<appwrite::BinaryResponse>
     */
    [[nodiscard]] appwrite::Result<appwrite::BinaryResponse> getFileDownload(        std::string_view bucketId,         std::string_view fileId,         std::optional<std::string_view> token = std::nullopt    ) {
     ...
     * @return appwrite::Result<appwrite::BinaryResponse>
     */
    [[nodiscard]] appwrite::Task<appwrite::Result<appwrite::BinaryResponse>> getFileDownloadAsync(        std::string_view bucketId,         std::string_view fileId,         std::optional<std::string_view> token = std::nullopt    ) {
                std::string path_ = std::format("/storage/buckets/{}/files/{}/download", bucketId, fileId);
     ...
     * @return appwrite::Result<appwrite::BinaryResponse>
     */
    [[nodiscard]] appwrite::Task<appwrite::Result<appwrite::BinaryResponse>> getFilePreviewAsync(        std::string_view bucketId,         std::string_view fileId,         std::optional<int64_t> width = 0,         std::optional<int64_t> height = 0,         std::optional<appwrite::enums::ImageGravity> gravity = appwrite::enums::ImageGravity::CENTER,         std::optional<int64_t> quality = -1,         std::optional<int64_t> borderWidth = 0,         std::optional<std::string_view> borderColor = std::nullopt,         std::optional<int64_t> borderRadius = 0,         std::optional<double> opacity = 1,         std::optional<int64_t> rotation = 0,         std::optional<std::string_view> background = std::nullopt,         std::optional<appwrite::enums::ImageFormat> output = std::nullopt,         std::optional<std::string_view> token = std::nullopt    ) {
                std::string path_ = std::format("/storage/buckets/{}/files/{}/preview", bucketId, fileId);
     ...
     * @return appwrite::Result<appwrite::BinaryResponse>
     */
    [[nodiscard]] appwrite::Result<appwrite::BinaryResponse> getFileView(        std::string_view bucketId,         std::string_view fileId,         std::optional<std::string_view> token = std::nullopt    ) {
     ...
     * @return appwrite::Result<appwrite::BinaryResponse>
     */
    [[nodiscard]] appwrite::Task<appwrite::Result<appwrite::BinaryResponse>> getFileViewAsync(        std::string_view bucketId,         std::string_view fileId,         std::optional<std::string_view> token = std::nullopt    ) {
                std::string path_ = std::format("/storage/buckets/{}/files/{}/view", bucketId, fileId);
...
public:
    ...
    Subscription subscribe(std::vector<std::string> channels, MessageCallback callback) {
        ...
        // Only connect() on first use — reuse the existing socket for subsequent subscriptions.
        if (isNewSocket && sock) sock->connect(endpoint, project);
        if (sock) sock->subscribe(allChannels);
