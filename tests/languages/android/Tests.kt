...
class ServiceTest {
    ...
    fun test() {
        ...
        runBlocking {
            ...
            writeToFile(Channel.buckets().file().toString())
            writeToFile(Channel.buckets("bucket1").file("file1").toString())
            writeToFile(Channel.buckets("bucket1").file("file1").delete().toString())
            writeToFile(Channel.functions().execution().toString())
            writeToFile(Channel.functions("func1").execution("exec1").toString())
            writeToFile(Channel.functions("func1").execution("exec1").create().toString())
            writeToFile(Channel.teams().toString())
            writeToFile(Channel.teams("team1").toString())
            writeToFile(Channel.teams("team1").create().toString())
            writeToFile(Channel.memberships().toString())
            writeToFile(Channel.memberships("membership1").toString())
            writeToFile(Channel.memberships("membership1").update().toString())
