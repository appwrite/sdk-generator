...
class DotNet80Test extends Base
{
    ...
    protected array $build = [
        ...
        'cp tests/languages/dotnet/Tests80.csproj tests/sdks/dotnet/src/test/Tests.csproj',
    ];
    protected string $command =
        'docker run --network="mockapi" --rm -v $(pwd):/app -w /app/tests/sdks/dotnet/src/test/ mcr.microsoft.com/dotnet/sdk:8.0-alpine3.19 dotnet test --verbosity normal --framework net8.0';
