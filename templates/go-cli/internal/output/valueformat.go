...
// Ports the scalar half of templates/cli/lib/response-config.ts: duration
// humanising and timestamp formatting, plus the key-aware dispatch that
// templates/cli/lib/parser.ts:478 does around them.
//
