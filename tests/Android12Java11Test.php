...
class Android12Java11Test extends Base
{
    ...
    protected string $command =
        'docker run --rm -v $(pwd):/app -w /app/tests/sdks/android alvrme/alpine-android:android-32-jdk-11 sh -c "./gradlew :library:testReleaseUnitTest -q && cat library/result.txt"';
