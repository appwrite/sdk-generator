...
// invitation to join a team after he is being redirected back to your app
// from the invitation email he was sent.
func (srv *Teams) UpdateMembershipStatus(TeamId string, InviteId string, UserId string, Secret string) (map[string]interface{}, error) {
	r := strings.NewReplacer("{teamId}", TeamId, "{inviteId}", InviteId)
