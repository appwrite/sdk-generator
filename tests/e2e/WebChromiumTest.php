...
final class WebChromiumTest extends Base
{
    ...
    protected string $command =
        'docker run --network="mockapi" --rm -v $(pwd):/app -e BROWSER=chromium -w /app/tests/e2e/sdks/web mcr.microsoft.com/playwright:v1.56.1-jammy node tests.js';
    ...
    protected array $expectedOutput = [
        ...
        ...Base::PUSH_RESPONSES,
        ...Base::PUSH_SESSION_CLIENT_ID_RESPONSES,
