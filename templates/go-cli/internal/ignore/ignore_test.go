...
// package itself, not verdicts anyone wrote down: recapture them from the
// package rather than editing one. A disagreement here is a real difference in
// which files would be deployed.
