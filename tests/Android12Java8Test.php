...
class Android12Java8Test extends Base
{
    ...
    protected string $command =
        'docker run --rm -v $(pwd):/app -w /app/tests/sdks/android alvrme/alpine-android:android-32-jdk-8 sh -c "./gradlew :library:testReleaseUnitTest -q && cat library/result.txt"';
