...
final class Python310Test extends Base
{
    #[Override]
    ...
    protected string $command =
        'docker run --network="mockapi" --rm -v $(pwd):/app -w /app --env PIP_TARGET=tests/e2e/sdks/python/vendor --env PYTHONPATH=tests/e2e/sdks/python/vendor python:3.10-alpine python tests/e2e/sdks/python/test.py';
