...
try {
    ...
    $spec = getSSLPage("https://raw.githubusercontent.com/appwrite/appwrite/feat-ssr/app/config/specs/swagger2-latest-server.json");
    ...
    // Node
    $node = new Node();
    $node->setNPMPackage('node-appwrite-local');
    $sdk  = new SDK($node, new Swagger2($spec));
