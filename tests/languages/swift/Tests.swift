...
class Tests: XCTestCase {
    ...
    func test() async throws {
        ...
        print(Operator.decrement(5, min: 0))
        print(Operator.multiply(2))
        print(Operator.divide(2))
        print(Operator.modulo(3))
        print(Operator.power(2))
        print(Operator.append("value"))
        print(Operator.append(["value1", "value2"]))
        print(Operator.prepend("value"))
        print(Operator.prepend(["value1", "value2"]))
        print(Operator.insert(0, "value"))
        print(Operator.insert(1, ["value1", "value2"]))
        print(Operator.remove("value"))
        print(Operator.remove(["value1", "value2"]))
