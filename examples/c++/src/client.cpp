...
Client& Client::addHeader(string key, string value) {
    ...
    this->headers.insert(std::pair<string, string>(keyLower, value));
    return *this;
}
 ...
 */
json Client::call(string method, string path, std::map<string, string> headers, std::map<string, string> params) {
/*
    ...
    std::map<string, string> call_headers(this->headers);
    call_headers.insert(headers.begin(), headers.end());
