...
execSync("node index client --endpoint 'https://8080-appwrite-appwrite-wp0ocjvurgi.ws-us62.gitpod.io' --projectId console --key=35y3h5h345 --selfSigned true", { stdio: 'inherit' });
