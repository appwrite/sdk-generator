...
print(Query.distance_equal("location", [40.7128, -74.0060], 1000))
print(Query.distance_equal("location", [40.7128, -74.0060], 1000, True))
print(Query.distance_not_equal("location", [40.7128, -74.0060], 1000))
print(Query.distance_not_equal("location", [40.7128, -74.0060], 1000, True))
print(Query.distance_greater_than("location", [40.7128, -74.0060], 1000))
print(Query.distance_greater_than("location", [40.7128, -74.0060], 1000, True))
print(Query.distance_less_than("location", [40.7128, -74.0060], 1000))
print(Query.distance_less_than("location", [40.7128, -74.0060], 1000, True))

# Spatial query tests
print(Query.intersects("location", [40.7128, -74.0060]))
print(Query.not_intersects("location", [40.7128, -74.0060]))
print(Query.crosses("location", [40.7128, -74.0060]))
print(Query.not_crosses("location", [40.7128, -74.0060]))
print(Query.overlaps("location", [40.7128, -74.0060]))
print(Query.not_overlaps("location", [40.7128, -74.0060]))
print(Query.touches("location", [40.7128, -74.0060]))
print(Query.not_touches("location", [40.7128, -74.0060]))
