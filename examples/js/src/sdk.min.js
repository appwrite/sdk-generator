...
let path='/storage/files';return http.post(path,{'content-type':'xxxx'},{'files':files,'read':read,'write':write,'folderId':folderId})},getFile:function(fileId){if(fileId===undefined){throw new Error('Missing required parameter: "fileId"')}
