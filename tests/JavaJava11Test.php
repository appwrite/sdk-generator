...
class JavaJava11Test extends Base
{
    ...
    protected string $command =
        'docker run --network="mockapi" --rm -v $(pwd):/app -w /app/tests/sdks/java maven:3.9-eclipse-temurin-11 sh -c "mvn compile exec:java -Dexec.mainClass=io.appwrite.Tests -q 2>/dev/null"';
