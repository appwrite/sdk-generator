...
describe('Operator', () => {
    ...
    test('returns divide with min', () => {
        expect(Operator.divide(4, 1)).toEqual(
    ...
    test('returns dateAddDays', () => {
        expect(Operator.dateAddDays(7)).toEqual(
            '{"method":"dateAddDays","values":[7]}',
        );
    });

    test('returns dateSubDays', () => {
        expect(Operator.dateSubDays(7)).toEqual(
            '{"method":"dateSubDays","values":[7]}',
        );
    });

    test('returns dateSetNow', () => {
        expect(Operator.dateSetNow()).toEqual(
