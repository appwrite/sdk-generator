...
final class DotNet90Test extends Base
{
    ...
    protected array $build = [
        ...
        'cp tests/e2e/languages/dotnet/Tests90.csproj tests/e2e/sdks/dotnet/test/Tests.csproj',
    ];
    #[Override]
    protected string $command =
        'docker run --network="mockapi" --rm -v $(pwd):/app -w /app/tests/e2e/sdks/dotnet/test mcr.microsoft.com/dotnet/sdk:9.0-alpine3.22 dotnet test --verbosity normal --framework net9.0';
