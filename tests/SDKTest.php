    ...
    protected $languages  = [
        ...
        'java' => [
            ...
            'build' => [
                ...
                'docker run --rm -v $(pwd):/app -w /app/tests/sdks/dart --env PUB_CACHE=vendor maven:3.6-jdk-11-slim mvn clean install',
            ],
            'envs' => [
                'java-11' => 'docker run --rm -v $(pwd):/app -w /app/tests/sdks/java --env PUB_CACHE=vendor maven:3.6-jdk-11-slim mvn clean install',
                'java-14' => 'docker run --rm -v $(pwd):/app -w /app/tests/sdks/java --env PUB_CACHE=vendor maven:3.6-jdk-14-slim mvn clean install',
            ],
        ],
