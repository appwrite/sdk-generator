...
puts Operator.decrement(5, 0)
puts Operator.multiply(2)
puts Operator.divide(2)
puts Operator.modulo(3)
puts Operator.power(2)
puts Operator.array_append("value")
puts Operator.array_append(["value1", "value2"])
puts Operator.array_prepend("value")
puts Operator.array_prepend(["value1", "value2"])
puts Operator.array_insert(0, "value")
puts Operator.array_insert(1, ["value1", "value2"])
puts Operator.array_remove("value")
puts Operator.array_remove(["value1", "value2"])
puts Operator.array_unique()
puts Operator.array_intersect(["value1", "value2"])
puts Operator.array_diff(["value1", "value2"])
puts Operator.array_filter(Condition::EQUAL, "value2")
puts Operator.string_concat("newValue")
puts Operator.string_replace("oldValue", "newValue")
puts Operator.bool_toggle()
puts Operator.date_add_days(7)
puts Operator.date_sub_days(7)
